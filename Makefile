...
SRCS_FILES := \
	...
	$(addprefix parsing/, parsing_init.c tokenizer_init.c tokenizer_utils.c tokenizer_counters.c tokenizer_redirec.c syntax_aut.c expand_init.c aut_token_count.c take_quote.c insert_exp.c) \
